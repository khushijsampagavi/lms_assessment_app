...
function SubscriptionPage() {
  ...
  return (
    <div>
      ...
      <Container className="mt-5" style={{backgroundImage: 'url( https://t3.ftcdn.net/jpg/05/00/34/58/360_F_500345899_4OqmtspFst6SRnNQvLj7h7TfKOrBwTer.jpg)'}}>
        <Row className="justify-content-center">
          <Col md={12}>
            ...
            <Card className='mb-4' style={{ background: 'linear-gradient(to right, hsl(50, 30%, 50%), hsl(25, 65%, 300%))'}}>
              <Card.Body>
                <Row>
              ...
              <Card.Body>
                <Row>
                  ...
                  <Col md={6} className="p-4 bg-white text-dark">
                    ...
                    <h3>₹999 INR</h3>
                    <Button variant="primary">Get access</Button>
                    <p className="mt-4">Invoices and receipts available for easy company reimbursement</p>
                  </Col>
                </Row>
              </Card.Body>
            </Card>
